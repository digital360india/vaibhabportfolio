const HeroSection = () => {
  return (
    <>
      <div
        className=" md:flex justify-center  md:p-24 md:w-full md:px-0 px-10  h-[932px] md:h-[540px] py-20  "
        style={{
      ...
      >
        ...
        <div className="md:pr-4 lg:pr-0">
          ...
          <div className="text-[16px] font-semibold text-[#62D2D3]  font-poppins md:text-right  mt-3">
          ...
          <div className=" ">
            <p className="font-poppins text-[14px] text-white font-light  mt-5 md:ml-20 md:text-right md:w-[500px]  ">
